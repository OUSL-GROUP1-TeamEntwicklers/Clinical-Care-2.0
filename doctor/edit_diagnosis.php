...
if (isset($_GET['edit_diagnosis'])) {
    $diagnosis_id = $_GET['edit_diagnosis'];
    $edit_diagnosis = true;
    $record_B = mysqli_query($db, "SELECT * FROM diagnosis WHERE diagnosis_id=$diagnosis_id"); 
...
<body>
	...
	<nav>
	    ...
	    <label id="title">| Edit Diagnosis</label>
	      <ul>
    ...
    <form action="edit_diagnosis.php" method="post" id="frm">
        ...
        <textarea id="test" name="diagnosis" value="<?php echo $diagnosis; ?>"><?php echo $diagnosis; ?></textarea><br><br>
    

        <input type="submit" name="update_diagnosis" value="Edit Diagnosis" id="booking">
    </form>
...
<table id="allusers" class="table table-striped table-bordered" style="width: 100%">
        ...
        <tbody> 
            <?php if (isset($_GET['add_diagnosis'])) {
